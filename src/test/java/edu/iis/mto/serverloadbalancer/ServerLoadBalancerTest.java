...
public class ServerLoadBalancerTest {
	...
	public void balancingAServerWithEnoughRoom_getsFilledWithAllVms() {
		...
		assertThat("server should contain the first vm", theServer.constains(theFirstVm));
		assertThat("server should contain the second vm", theServer.constains(theSecondVm));
	}
	...
	public void aVm_shouldBeBalanced_onLessLoadedServerFirst() {
		...
		assertThat("less loaded server should contain the vm", lessLoadedServer.constains(theVm));
		assertThat("more loaded server should not contain the vm", !moreLoadedServer.constains(theVm));
	}
	...
	public void balanceAServerWithNotEnoughRoom_shouldNotBeFilledWithAVm() {
		...
		balancing(aServersListWith(theServer), aVmsListWith(theVm));
		assertThat("server should not contain the vm", !theServer.constains(theVm));
	}
	...
	public void balance_ServersAndVms() {
		...
		assertThat("server 1 should contain the vm1", server1.constains(vm1));
		assertThat("server 2 should contain the vm2", server2.constains(vm2));
		assertThat("server 1 should contain the vm3", server1.constains(vm3));
